...
export default function AddNewStaff() {
  ...
  return (
    <div className="p-6">
      <button onClick={() => navigate(-1)} className="text-blue-600 hover:underline hover:brightness-150 cursor-pointer mb-4">← Back</button>
      <h1 className="text-lg font-bold mb-6">Add a New Staff</h1>
