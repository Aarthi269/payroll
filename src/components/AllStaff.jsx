    ...
    <div className="bg-white rounded-lg p-6 shadow-sm">
      ...
      <div className="flex justify-between items-start mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500">View, search for and add new staff</p>
        </div>
      ...
      {/* Filters Row */}
      <div className="flex flex-wrap items-center justify-between bg-gray-50 p-4 rounded-md mb-4">
      ...
      <div className="flex items-center justify-between mt-4">
        ...
        <div className="flex space-x-1">
          ...
          <button className="px-3 py-1 border rounded-md bg-white text-gray-600 hover:bg-blue-50">
            &gt;&gt;
          </button>
        </div>
      </div>
